...
![Risk Prediction Panel](docs/screenshots/risk_panel.png)
![Keyword Extraction](docs/screenshots/keywords.png)
![PDF Report Sample](docs/screenshots/pdf_report.png)
```
